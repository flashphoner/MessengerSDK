...
- [handleCreateEncryptedChat](https://github.com/flashphoner/MessengerSDKSamples/blob/1.0/src/components/containers/encryptedGroupChat/panel/EncryptedGroupChatPanel.tsx#L95-L141) - call in a component
