  ...
  return (
    <div className="calc-main-height bg-gray-50 flex flex-col ">
      ...
      <div className="flex-grow overflow-y-auto px-4 py-6 bg-white shadow-inner">
        <div className="prose max-w-full prose-indigo prose-headings:font-bold prose-headings:leading-tight prose-headings:mb-6 prose-p:leading-relaxed prose-p:mb-6 prose-li:mb-4 prose-li:marker:text-indigo-600 prose-ul:list-disc prose-ul:list-outside">
