**Change Nickname SDK Usage Guide**
...
2. 💬 **Group Chat Management**: Create group chats.
3. ✏️ **Nickname Change**: Update your nickname, and changes are visible to all participants.
4. 👥 **Contacts**: View the updated contacts with modified nicknames.
