...
sequenceDiagram
    ...
    Alice ->> SDK: 14. leaveSpace()
    SDK -->> Bob: 15. Event USER_LEFT_SPACE
    SDK -->> Bob: 16. Event CONTACT_DELETED
    SDK -->> Alice: 17. Event CONTACT_DELETED
```
...
### 14. Alice calls **[leaveSpace](leaveSpace)**
- Enter the Invite Code provided by the space creator, then click Join.

**Call**
[Github (Lines 91)](https://github.com/flashphoner/MessengerSDKSamples/blob/1.0/src/hooks/sdk/useSdkSpaces.ts#L91-L91)

**Doc**
[Github (Lines 83-86)](https://github.com/flashphoner/MessengerSDKSamples/blob/1.0/src/hooks/sdk/useSdkSpaces.ts#L83-L86)

### 15. Bob receives USER_LEFT_SPACE
[Github (Lines 81–88)](https://github.com/flashphoner/MessengerSDKSamples/blob/1.0/src/events/space.ts#L81-L88)

### 16. Bob receives CONTACT_DELETED
...
### 17. Alice receives CONTACT_DELETED
